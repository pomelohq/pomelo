...
enum SettingsStore {
    ...
    static func remoteInfo() async -> Data { await off { PomCore.shared.remoteInfoData() } }
    static func remoteSet(enabled: Bool) async -> Data { await off { PomCore.shared.remoteSet(enabled: enabled) } }
