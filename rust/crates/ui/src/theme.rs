...
pub fn one_dark() -> ThemeColors {
    ...
    ThemeColors {
        ...
        player_selection: h("#74ade83d"),
        terminal_background: h("#282c34"),
        terminal_ansi_background: h("#111110"),
        terminal_foreground: h("#abb2bf"),
        terminal_bright_foreground: h("#dce0e5"),
        terminal_dim_foreground: h("#636d83"),
        terminal_ansi: [
            h("#282c34"),
            h("#e06c75"),
            h("#98c379"),
...
pub fn one_light() -> ThemeColors {
    ...
    ThemeColors {
        ...
        player_selection: h("#5c78e23d"),
        terminal_background: h("#fafafa"),
        terminal_ansi_background: h("#fdfdfc"),
        terminal_foreground: h("#2a2c33"),
        terminal_bright_foreground: h("#2a2c33"),
        terminal_dim_foreground: h("#bbbbbb"),
        terminal_ansi: [
            h("#000000"),
            h("#de3e35"),
            h("#3f953a"),
...
pub fn gruvbox_dark() -> ThemeColors {
    ...
    ThemeColors {
        ...
        player_selection: h("#83a5983d"),
        terminal_background: h("#282828"),
        terminal_ansi_background: h("#111110"),
        terminal_foreground: h("#ebdbb2"),
        terminal_bright_foreground: h("#fbf1c7"),
        terminal_dim_foreground: h("#766b5d"),
        terminal_ansi: [
            h("#282828"),
            h("#cc241d"),
            h("#98971a"),
...
pub fn ayu_mirage() -> ThemeColors {
    ...
    ThemeColors {
        ...
        player_selection: h("#72cffe3d"),
        terminal_background: h("#242835"),
        terminal_ansi_background: h("#111110"),
        terminal_foreground: h("#cccac2"),
        terminal_bright_foreground: h("#cccac2"),
        terminal_dim_foreground: h("#8e8d87"),
        terminal_ansi: [
            h("#242835"),
            h("#f18779"),
            h("#d5fe80"),
